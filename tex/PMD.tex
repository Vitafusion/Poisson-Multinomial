...
In game theory, \citeN{Cheng2017PlayingAG} explored the connection between Nash equilibria and $\PMD$. In the field of digital imaging, \citeN{akter2019double} applied $\PMD$ to build image authentication architecture which will work for 3D digital color images.
