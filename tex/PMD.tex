...
\begin{example}\normalfont
We have three candidates and four voters, the result of voting is a random variable $\Xmat \sim \PMD(\Pmat)$ where
\begin{equation*}
...
\begin{figure}%[h]
\centering
\includegraphics[width=0.95\textwidth]{figures/mae_plot.pdf}
...
\begin{figure}%[h]
	\centering
	\includegraphics[width=0.95\textwidth]{figures/tae_plot.pdf}
