...
\usepackage{latexsym,epsfig,graphicx,epstopdf,amsmath,amssymb,amscd,undertilde,multirow,chicago,psfrag,paralist,dsfont,url}
...
\begin{document}
	...
	%%%%%%%%%%%%TITLE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{The Computing of Probability Distribution Functions for the Poisson-Multinomial Distribution}
...
\begin{thm}
The mean and variance-covariance matrix for the PMD is .
...
\begin{thm}
Central limit theorem with approximation bound.
...
\\
The total likelihood $L = \prod_{i=1}^{61}\ell_i$, we can use numerical methods eg. gradient descent, Newton method to find the $\betavec$ that maximized $L$, then we get our final $P_i$ matrices.\\
\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Uncertainty Quantification in Soft Classfication}
