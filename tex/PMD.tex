...
$$\Xmat  = \sum_{i = 1}^n \boldsymbol{\rm I}_i \sim \PMD(n,m,\Pmat_{\rm n\times m}),$$
...
is of interest. Moreover, in the next section, we will focus on $p(x_1, \dots, x_{m-1})$ because $x_{m} = n-\sum_{i=1}^{m-1}x_i $. \\
