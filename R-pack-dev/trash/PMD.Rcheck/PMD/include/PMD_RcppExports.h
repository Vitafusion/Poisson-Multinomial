...
#ifndef RCPP_PMD_RCPPEXPORTS_H_GEN_
#define RCPP_PMD_RCPPEXPORTS_H_GEN_
...
namespace PMD {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            require("PMD", Rcpp::Named("quietly") = true);
            typedef int(*Ptr_validate)(const char*);
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("PMD", "_PMD_RcppExport_validate");
            if (!p_validate(sig)) {
                throw Rcpp::function_not_exported(
                    "C++ function with signature '" + std::string(sig) + "' not found in PMD");
            }
        }
    }
    ...
    inline arma::vec pmn_mdfft_arma(int nnt, arma::mat pp, arma::vec nn_vec, arma::vec l_vec, arma::vec cn_vec) {
        ...
        if (p_pmn_mdfft_arma == NULL) {
            ...
            p_pmn_mdfft_arma = (Ptr_pmn_mdfft_arma)R_GetCCallable("PMD", "_PMD_pmn_mdfft_arma");
        }
    ...
    inline arma::vec rpmd_arma(arma::mat pp) {
        ...
        if (p_rpmd_arma == NULL) {
            ...
            p_rpmd_arma = (Ptr_rpmd_arma)R_GetCCallable("PMD", "_PMD_rpmd_arma");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline double pmd_simulation_singlepoint(arma::mat pp, arma::vec x_vec, int t) {
        ...
        if (p_pmd_simulation_singlepoint == NULL) {
            ...
            p_pmd_simulation_singlepoint = (Ptr_pmd_simulation_singlepoint)R_GetCCallable("PMD", "_PMD_pmd_simulation_singlepoint");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline arma::vec pmd_simulation_allpoints(arma::mat pp, int nnt, arma::vec l_vec, arma::vec cn_vec, int t) {
        ...
        if (p_pmd_simulation_allpoints == NULL) {
            ...
            p_pmd_simulation_allpoints = (Ptr_pmd_simulation_allpoints)R_GetCCallable("PMD", "_PMD_pmd_simulation_allpoints");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
...
#endif // RCPP_PMD_RCPPEXPORTS_H_GEN_
